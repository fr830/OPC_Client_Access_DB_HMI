...
long COPCClient::Connect(long lngInterval)
{
	...
	if (ret == OPC_S_UNSUPPORTEDRATE)
	{	
		//TODELUSWarn( 0, 'opc', "Connect", "Unsupported Update Rate (%d): Revised to %d ms", lngInterval,RevisedUpdateRate );
	}
	else
	{
		if (FAILED(ret))
	...
	if(m_hPLCLoop == NULL)
	{
		//TODELUSError( 0, 0, "Start", "Cannot start PLCThread" );
		return( E_FAIL );
	}
...
///////////////////////////////////////////////////////TODEL///////
///////////////////////////////////////////////////////TODEL///////
/*void COPCClient::Loop(typRecipe *pRecipe)
{
	while( 1 )
	{
...
m_bLoopExit = true;/////////////////////////////////////////////////////////////////////////////
			//Quit bit New Coil 
			if(!pRecipe->bNewCoil && pRecipe->bAckNewCoil)
				pRecipe->bAckNewCoil = false;

			//SendToPLC();
			//TODELt3 = timeGetTime();

			//TODELif(t3-t1<m_lngInterval)
				Sleep(500); //TODELm_lngInterval-(t3-t1));
		}
		else
			Sleep(10);
	}
...
/////////////////////TODEL////////////////////////////////////////////////////////////////////////////////
			...
			myfile << m_pRecipe->strOrderName << endl;
			myfile << m_pRecipe->strCoilNumber << endl;
			myfile << m_pRecipe->strCustomerName << endl;
			myfile << m_pRecipe->strNuance << endl;
			myfile << m_pRecipe->strEtat << endl;
			myfile << m_pRecipe->lngThickness << endl;
			myfile << m_pRecipe->lngWidth << endl;
			myfile << m_pRecipe->lngYieldStrength << endl;
			myfile << m_pRecipe->strCassetteName << endl;
			myfile.close();
